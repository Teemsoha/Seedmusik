    ...
    async def join_call(
        ...
        try:
            ...
            try:
                ...
                raise AssistantErr(
                    "**◎ ¦ يسطي الكول مقفول**\n\n◎ ¦ افتح كول الاول علشان اطلع اغني او اشغل قراءن. و لو مفتوحه يسطي اقفلها و افتحها تاني او  , اكتب ( **ريستارت أو restart** ) دون استخدام اي علامات "
                )
        except AlreadyJoinedError:
            raise AssistantErr(
                "**◎ ¦ يـسطي المساعد ف الـكول**\n\n◎ ¦ اكتشف النظام ان المساعد بلفعل في المحادثه الصوتيه بلفعل, هذه المشكله تاتي عندما يتم تشغيل البوت مرتين.\n\nاذا لم يكن المساعد يعمل في المحادثه قم باانهاء المحاثه وتشغيلها من جدي واذا استمرت المشكله قم بتحديث البوت, اكتب ( **ريستارت أو restart** ) دون استخدام اي علامات •"
            )
        except TelegramServerError:
            raise AssistantErr(
                "**خطأ بسيرفرات التليجرامr**\n\nالتليجرام لديه مشاكل بسيرفراته, قم بتشغيل الاغاني لاحقا.\n\n اءا كانت المشكله تأتي بستمرار قم باغلاق المحادثه الصوتيه وشغلها من جديد."
            )
